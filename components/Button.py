...
class Button:
    ...
    """
    def __init__(self, w=350, h=35, pos=(300, 420), font_size=21):
        """
        Parameters
        ----------
        w: int
    ...
    def render(self, screen, text):
        ...
        if self.rect.w - 8 > font.size(str(text))[0]:
            ...
            screen.blit(text1, (self.rect.x + 10, self.rect.y + 4))
        else:
            text += " "
            t = ""
            line = 0
            for string in text.split(" "):
                ...
                if self.rect.w - 8 < font.size(str(t))[0] and string != "":
                    ...
                    screen.blit(text1, (self.rect.x + 10, self.rect.y + 4 + (line * (self.font_size+10))))
                    t = string + " "
                    line += 1
                else:
